...
(function (global) {
    ...
    // ─────────────────────────────────────────────────────────────────────
    // Styles (scoped to the UI Strings page)
    // ─────────────────────────────────────────────────────────────────────

    function injectStyles() {
        if (document.getElementById('ui-strings-styles')) return;
        const css = `
        #page-ui-strings { display: none; flex: 1; flex-direction: column; min-height: 0; }
        body.page-ui-strings #page-ui-strings { display: flex; }
        body.page-ui-strings #page-dialogue { display: none; }
        body.page-ui-strings .help-overlay { display: none; }

        .topbar-ui-strings { display: flex; gap: 12px; align-items: center; flex-wrap: wrap; }
        .topbar-ui-strings .ctrl-import {
            display: inline-flex;
            align-items: center;
            gap: 4px;
            padding: 4px 10px;
        ...
        .ui-strings-status.muted { color: var(--fg-dim); }
        .ui-strings-status.clean { color: #88e088; }
        .ui-strings-status.dirty {
            color: #e0c060;
            background: rgba(220, 200, 100, 0.10);
            border: 1px solid rgba(220, 200, 100, 0.30);
        }

        .ui-strings-sheet-tabs {
            display: flex;
            flex-wrap: wrap;
            gap: 0;
            background: var(--bg-1);
        ...
        .ui-strings-sheet-tab:hover { color: var(--fg); background: rgba(255,255,255,0.04); }
        .ui-strings-sheet-tab.active {
            color: var(--accent);
        ...
        .ui-strings-filter:focus { outline: 1px solid var(--accent); }
        .ui-strings-counter { color: var(--fg-dim); font-size: 12px; }
        ...
        .ui-strings-table tbody tr:hover td { background: rgba(255,255,255,0.03); }

        .ui-col-idx { width: 48px; text-align: right; color: var(--fg-dim); font-family: ui-monospace, monospace; font-size: 11px; }
        .ui-col-key { min-width: 160px; max-width: 240px; }
        .ui-cell-key {
            font-family: ui-monospace, "Cascadia Code", monospace;
            color: #b8d8ff;
            background: rgba(120, 180, 255, 0.05);
        }
        .ui-cell-text { cursor: text; min-width: 180px; }
        .ui-cell-text:hover {
            background: rgba(120, 180, 255, 0.08);
            outline: 1px dashed rgba(120, 180, 255, 0.4);
            outline-offset: -1px;
        }
        .ui-cell-empty { color: var(--fg-dim); font-style: italic; opacity: 0.5; }
        .ui-cell-empty::before { content: '— 空 —'; opacity: 0.6; }

        .ui-strings-divider td {
        ...
        .ui-cell-editor { display: flex; gap: 4px; align-items: stretch; }
        .ui-cell-editor textarea {
            flex: 1;
            min-height: 2.4em;
            font: inherit;
            background: var(--bg);
        ...
        .ui-cell-editor button.confirm { border-color: #6c6; }
        .ui-cell-editor button.confirm:hover { background: rgba(100, 200, 100, 0.15); }
        .ui-cell-editor button.cancel  { border-color: #c66; }
        .ui-cell-editor button.cancel:hover { background: rgba(200, 100, 100, 0.15); }
        `;
        const style = document.createElement('style');
        style.id = 'ui-strings-styles';
