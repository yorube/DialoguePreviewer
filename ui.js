...
(function () {
  ...
  const I18N = {
    en: {
      ...
      'tr.alert.sourceLocaleDownload': 'Download produces a translation file (en-US source → target language). {locale} is the source language, so there is nothing to download as a translation.\n\nWhat to do:\n  1. Switch the "Text language" selector to a target language (ru-RU / fr-FR / it-IT / es-ES / ja-JP).\n  2. Then press [💾 Download] again.',
    ...
    zh: {
      ...
      'tr.alert.sourceLocaleDownload': '下載會產出一份翻譯檔（en-US 原文 → 目標語言）。{locale} 是來源語言，所以沒有「翻譯」可以下載。\n\n要怎麼處理：\n  1. 把上方「文本語言」切到目標語言（ru-RU / fr-FR / it-IT / es-ES / ja-JP）。\n  2. 再按一次 [💾 下載譯文]。',
